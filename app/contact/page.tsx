    ...
    <LegalLayout title="Contact &amp; Support" lastUpdated="23 March 2026">
      ...
      <div className="not-prose grid sm:grid-cols-2 gap-4 my-8">
        ...
        <a
          ...
          className="group flex items-start gap-4 rounded-xl border border-border bg-muted/50 p-5 hover:border-primary hover:bg-indigo-50/50 dark:hover:bg-indigo-950/30 transition-colors"
        >
          <div className="w-10 h-10 rounded-lg bg-card border border-border flex items-center justify-center shrink-0 shadow-sm group-hover:border-indigo-200 dark:group-hover:border-indigo-800 transition-colors">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm font-mono text-primary truncate">skriver@live.dk</p>
            <p className="text-xs text-muted-foreground mt-1">For account, privacy &amp; non-public issues</p>
          </div>
        </a>
        ...
        >
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-foreground mb-0.5">GitHub Issues</p>
            <p className="text-sm font-mono text-primary truncate">sumsar01/better-task-manager</p>
            <p className="text-xs text-muted-foreground mt-1">Bugs, features &amp; public feedback</p>
          </div>
        </a>
      </div>
