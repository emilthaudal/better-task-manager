        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mb-2.5 flex-wrap">
            {jiraBaseUrl ? (
              ...
              <span className="inline-flex items-center text-xs font-mono font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-200 dark:border-indigo-800/60 px-2.5 py-1 rounded-lg">
                {issueKey}
              </span>
            )}
            {f && (
