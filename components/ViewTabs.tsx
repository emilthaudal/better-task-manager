...
export default function ViewTabs({ activeTab, onTabChange }: ViewTabsProps) {
  return (
    <div className="flex items-center gap-1 px-5 py-2 bg-background border-b border-border shrink-0">
      <TabButton
        label="Graph"
        icon={<GraphIcon />}
  ...
  return (
    <button
      ...
      className={[
        ...
        active
          ? "bg-indigo-50 dark:bg-indigo-950/60 text-primary border border-primary/20"
